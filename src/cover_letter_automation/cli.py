...
def make_cover_letter(  # noqa: PLR0917, PLR0913
    ...
    openai_model: Annotated[
        str | None, typer.Option(envvar="OPENAI_MODEL_NAME", help="OpenAI model")
    ] = "gpt-4-turbo-preview",
    bing_api_key: Annotated[str | None, typer.Option(envvar="BING_API_KEY", help="Bing API key")] = None,
    motivation: Annotated[Path | None, typer.Option(help="Path to the motivation text file", exists=True)] = None,
) -> None:
    ...
    llm_config = {"config_list": [{"model": openai_model, "api_key": openai_api_key}], "cache_seed": None}
    ...
    try:
        ...
        rprint("Unable to retrieve cost, see full array: ", chat.cost)
